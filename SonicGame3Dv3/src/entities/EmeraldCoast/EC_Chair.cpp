...
EC_Chair::EC_Chair(float x, float y, float z, float rotY)
{
	this->position.x = x;
	this->position.y = y;
	this->position.z = z;
	...
	collideModelTransformed = loadCollisionModel("Models/EmeraldCoast/", "Chair");
...
void EC_Chair::loadStaticModels()
{
	...
	{
		EC_Chair::cmOriginal = loadCollisionModel("Models/EmeraldCoast/", "Chair");
	}
}
