...
float MotoBug::colHorizontal = 5;
float MotoBug::colVertical = 10;
...
void MotoBug::moveMe()
{
	xVel += (0.4f*cosf(toRadians(-getRotY())));
	zVel += (0.4f*sinf(toRadians(-getRotY())));
}
	
void MotoBug::moveMeSlow()
{
	xVel += (0.2f*cosf(toRadians(-getRotY())));
	zVel += (0.2f*sinf(toRadians(-getRotY())));
}
