...
private:
	...
	const float flyYSpeedIncrease = 0.75f; //How much each fly press increases your yVel
	const float flyYSpeedMax = 3.0f; //Threshold for allowing yVel increase when flying
