...
HorizontalBlurShader::HorizontalBlurShader(char* vFile, char* fFile)
{
...
void HorizontalBlurShader::bindAttribute(int attribute, char* variableName)
{
...
int HorizontalBlurShader::getUniformLocation(char* uniformName)
{
