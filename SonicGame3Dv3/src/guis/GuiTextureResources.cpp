...
void GuiTextureResources::loadGuiTextures()
{
	...
	INCR_NEW textureRing        = new GuiTexture(Loader_loadTexture("res/Images/Ring.png"),     o + 0.5f*w + 16*px, 0.0212f+48*py,  32*px, 32*py, 0 );
	INCR_NEW textureBlueLine    = new GuiTexture(Loader_loadTexture("res/Images/BlueLine.png"), 0.5f, 0.5f, 10*16*px, 10*128*py, 29.5f);
